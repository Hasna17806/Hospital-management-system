...
-- 0. USERS (1 admin account to log in with)
-- Email: admin@meridian.com   Password: admin123
-- (the value below is a bcrypt HASH of "admin123" — never the real password)
INSERT INTO users (name, email, password_hash, role) VALUES
('Admin User', 'admin@meridian.com', '$2b$10$CtjIGISeI4ldIqwP8JqxvOdrxIUwGqWmngCRRvrzs24lqq.vEl2Ue', 'admin');
